...
/* These functions have custom register assignments via #pragma aux.
 * gr_linear_movsd is defined with inline ASM in bitblt.c.
 * gr_linear_movsb/movsw/stosd are in linear.asm. */
...
void gr_linear_stosd( ubyte * dest, unsigned char color, int nbytes);
