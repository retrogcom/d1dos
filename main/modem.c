...
void com_dump_string(char *string)
{
	mprintf((0, "%s\n", string));
}
#else
...
int com_check_message(char *checkbuf, int len)
{
	ushort check;
	int seqnum;
...
void com_process_menu(char *buf, int len)
{
	char text[80];
...
void com_process_other_menu_choice(void)
{
...
void com_wait_for_connect(int nitems, newmenu_item *menus, int *key, int citem)
{
	int result;
...
void com_wait_for_ring(int nitems, newmenu_item *menus, int *key, int citem)
{
	int result;
	char input_buffer[81];
