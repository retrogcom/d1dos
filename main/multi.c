...
void multi_do_message(char *buf)
{
	char *colon;
...
void multi_do_position(char *buf)
{		
...
void multi_do_reappear(char *buf)
{
	short objnum;
...
void multi_do_player_explode(char *buf)
{
...
void multi_do_decloak(char *buf)
{
	int pnum;
...
void multi_do_door_open(char *buf)
{
	int segnum;
	short side;
	segment *seg;
...
void multi_do_create_explosion(char *buf)
{
	int pnum;
	int count = 1;
...
void multi_do_controlcen_fire(char *buf)
{
...
void multi_do_create_powerup(char *buf)
{
	short segnum;
	short objnum;
	int my_objnum;
...
void multi_do_play_sound(char *buf)
{
	int pnum = buf[1];
#ifdef SHAREWARE
...
void multi_do_trigger(char *buf)
{
	int pnum = buf[1];
	int trigger = buf[2];
...
void multi_process_data(char *buf, int len)
{
