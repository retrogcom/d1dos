...
void network_endlevel_poll( int nitems, newmenu_item * menus, int * key, int citem )
{
...
void network_pack_objects(void)
{
...
int network_wait_for_sync(void)
{
	char text[60];
	newmenu_item m[2];
	int i, choice;
